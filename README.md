...
▸ Translating real-world business processes into deterministic software
▸ Preventing invalid actions before they become problems
...
▸ If data changes, the reason must be visible
▸ If something can be deleted, it must be recoverable
...
▸ Patterns: OOP, state-based workflows
▸ Additional Tools: Docker, GIT/GITHUB, DBeaver, XAMPP
...
▸ UI that hides broken logic
▸ Code that cannot be explained end-to-end
...
▸ Building software meant to last inside real organizations
